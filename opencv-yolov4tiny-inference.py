...
import cv2
import os
weightsPath = '/home/xwh/cone-test/roadblock-v4-tiny-3l_1108_best.weights'#模型权重文件
configPath = '/home/xwh/cone-test/roadblock-v4-tiny-3l_1108.cfg'#模型配置文件
labelsPath = '/home/xwh/cone-test/roadblock.names'#模型类别标签文件
#初始化一些参数
...
#读入待检测的图像
image = cv2.imread('/home/xwh/cone-test/202007211(1)_0001.jpg')
#得到图像的高和宽
(H,W) = image.shape[0: 2]
